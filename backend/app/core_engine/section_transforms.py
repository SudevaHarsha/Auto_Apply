"""Section transforms (copied from vendor transform.py:6-483, I9 unchanged).

Normalizes each section's raw LLM output into its JSONResume shape.
Imports rewritten: no vendor dependencies.
"""
...
def parse_date_range(date_range: str) -> tuple[str | None, str | None]:
