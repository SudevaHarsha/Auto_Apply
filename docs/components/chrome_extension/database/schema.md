...
> **Canonical source:** `docs/database/schema.md` — migration 009 (evidence).

SQL for tables owned by the chrome extension component.
...
CREATE POLICY evidence_isolated ON evidence
